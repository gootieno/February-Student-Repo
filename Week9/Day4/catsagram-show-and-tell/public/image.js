...
export const buildImageContainer = () => {
  ...
  catImageContainer.style.position = "relative";
  catImageContainer.style.zIndex = "4";
  catImageContainer.style.width = "400px";
  catImageContainer.style.height = "300px";
  catImageContainer.style.top = "40px";
  catImageContainer.style.cursor = "pointer";

  //appending image element to the transitionContainer element
...
const createImageElement = async () => {
  ...
  imageElement.style.boxShadow = "0px 0px 3px gray";
