...
export const buildCommentsContainer = () => {
  ...
  commentHeading.setAttribute("id", "comments-heading");
  commentHeading.setAttribute(
    "class",
    transitionState ? "show-comment-title" : "hide-comment-title"
  );

  if (darkMode) commentHeading.classList.add("dark-mode-text");
  else commentHeading.classList.add("light-mode-text");

  commentHeading.style.position = "relative";
  commentHeading.style.textAlign = "center";
  commentHeading.style.zIndex = "3";
  commentHeading.style.marginTop = "5px";
  commentHeading.innerText = "Comments";

  commentContainer.append(commentHeading);
  transitionContainer.append(commentContainer);
...
export const commentBox = () => {
  ...
  if (storageComments) {
    storageComments.forEach(([storedDate, storedComment]) => {
      ...
      if (darkMode) {
        comment.classList.add("dark-mode-text");
        commentDate.classList.add("dark-mode-text");
      } else {
        comment.classList.add("light-mode-text");
        commentDate.classList.add("light-mode-text");
      }
  ...
  comments.style.boxShadow = "0px 0px 10px gray";
  comments.style.boxSizing = "border-box";
  comments.style.width = "400px";
  comments.style.height = "280px";
...
export const inputContainer = () => {
  ...
  inputContainer.setAttribute(
    "class",
    transitionState ? "show-form" : "hide-form"
  );
  ...
  commentInputField.setAttribute("class", "input-shrink");
  // set styles for comment input
  commentInputField.style.borderRadius = "5px";
  commentInputField.style.borderWidth = "0px";
  commentInputField.style.boxShadow = "0px 0px 5px gray";

  commentInputField.addEventListener("focus", (e) => {
    e.target.classList.remove("input-shrink");
    e.target.classList.add("input-grow");
  });

  // create button for submitting comment
  const submitButton = document.createElement("div");
  submitButton.style.border = "1.5px solid gray";
  ...
  commentBox.append(inputContainer);
};
...
const createCommentElements = () => {
  ...
  commentDate.style.margin = "5px 0px 0px 5px";
  commentDate.style.fontWeight = "bold";
...
export const handleCommentSubmit = () => {
  ...
  // listen for any click/submit events
